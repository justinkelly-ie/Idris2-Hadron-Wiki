# Primordial Plasma Recombination & Photon Decoupling Observation

## Overview & Theoretical Foundation

In the early Universe, high-energy plasma composed of ionized protons ($p^+$) and electrons ($e^-$) cooled sufficiently to allow neutral Hydrogen atom formation ($H^0 = p^+ + e^-$), triggering photon decoupling and the Cosmic Microwave Background (CMB). Net electrical charge and total mass are strictly conserved.
...
------------------------------------------------------------------------
-- 1. PRIMORDIAL PLASMA TO NEUTRAL RECOMBINATION
------------------------------------------------------------------------
